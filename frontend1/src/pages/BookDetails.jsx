                                ...
                                {isLoggedIn && (
                                    <div className="wishlist-section">
                                        <div className="wishlist-dropdown-container">
                                            <button 
                                                className={`wishlist-button ${bookWishlists.length > 0 ? 'in-wishlist' : ''}`}
                                        ...
                                        {bookWishlists.length > 0 && (
                                            <div className="book-wishlists">
                                                <p>
                                                    <strong>In wishlists:</strong> {bookWishlists.map((w, index) => (
                                                        <span key={w.wishlist_id} className="wishlist-tag">
                                                            {w.name}{index < bookWishlists.length - 1 ? ', ' : ''}
                                                        </span>
                                                    ))}
                                                </p>
                                            </div>
